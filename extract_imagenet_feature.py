...
def main(resolution=256):
    ...
    train_dataset_loader = DataLoader(train_dataset, batch_size=4, shuffle=False, drop_last=False,
                                      num_workers=8, pin_memory=True, persistent_workers=True)

    model = get_model('/home/ubuntu/data/repos/MaskDiT/assets/vae/autoencoder_kl.pth')
